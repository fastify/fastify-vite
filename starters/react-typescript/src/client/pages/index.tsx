  ...
  return (
    <>
      ...
      <ul className="columns-2">
        ...
        <li>
          <Link to="/form/123">/form/123</Link> — <code>POST</code> to dynamic route.
        </li>
        <li>
        ...
        <li>
          <Link to="/server-only">/server-only</Link> — <code>0kb</code> JavaScript.
        </li>
        <li>
          <Link to="/streaming">/streaming</Link> — <b>streaming</b> SSR.
        </li>
        <li>
          <Link to="/wildcard/another/one">/wildcard/another/one</Link> —{' '}
