<template>
  ...
  <ul class="columns-2">
    <li>
      <router-link to="/using-data">/using-data</router-link> — <b>isomorphic data fetching</b>.
    </li>
    <li>
      <router-link to="/using-store">/using-store</router-link> — <b>universal</b>
      <code>reactive()</code> stores.
    </li>
    <li><router-link to="/using-auth">/using-auth</router-link> — <b>custom layout</b>.</li>
    <li>
      <router-link to="/form/123">/form/123</router-link> — <code>POST</code> to dynamic route.
    </li>
    <li><router-link to="/client-only">/client-only</router-link> — <b>disabling</b> SSR.</li>
    <li>
      <router-link to="/server-only">/server-only</router-link> — <code>0kb</code> JavaScript.
    </li>
    <li><router-link to="/streaming">/streaming</router-link> — <b>streaming</b> SSR.</li>
    <li>
      <router-link to="/wildcard/another/one">/wildcard/another/one</router-link> —
