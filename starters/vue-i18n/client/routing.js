import { serverRouteContext } from '@fastify/vue/client'
...
export function createServerBeforeEachHandler ({ routeMap, ctxHydration }) {
...
export function createClientBeforeEachHandler ({ routeMap, ctxHydration }, layout) {
